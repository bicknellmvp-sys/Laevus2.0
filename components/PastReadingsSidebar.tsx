        ...
        <div className="w-screen max-w-xl bg-[#09090b] border-l border-zinc-800 shadow-[0_0_80px_rgba(0,0,0,0.9)] flex flex-col z-50 text-zinc-200">
          ...
          <div className="p-4 sm:p-5 border-b border-zinc-850 bg-black/70 flex items-center justify-between flex-shrink-0">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-[#E60026]/10 border border-[#E60026]/40 flex items-center justify-center text-[#E60026]">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded-full bg-zinc-900 border border-zinc-800 text-[10px] font-mono text-[#E60026] font-bold">
                    {readings.length}
                  </span>
                </div>
            ...
            <div className="flex items-center gap-1.5">
              {readings.length > 0 && (
                <button
                  ...
                  className="p-2 text-zinc-400 hover:text-zinc-100 hover:bg-zinc-900 rounded-lg transition-colors cursor-pointer border border-transparent hover:border-zinc-800"
                >
              ...
              <button
                onClick={onClose}
                className="p-2 text-zinc-400 hover:text-white hover:bg-zinc-900 rounded-lg transition-colors cursor-pointer border border-transparent hover:border-zinc-800"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
          ...
          <div className="p-3 sm:p-4 border-b border-zinc-900 bg-zinc-950/60 space-y-2.5 flex-shrink-0">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-black border border-zinc-800 focus:border-[#E60026] text-xs pl-8 pr-8 py-2 rounded-lg text-zinc-200 placeholder-zinc-600 outline-none transition-colors font-google-sans"
              />
              {searchQuery && (
                <button
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-full whitespace-nowrap uppercase tracking-wider transition-colors cursor-pointer ${
                  selectedPersonaFilter === 'all'
                    ? 'bg-[#E60026] text-black font-bold'
              ...
              <div className="py-16 text-center space-y-3 max-w-sm mx-auto">
                ...
                {(searchQuery || selectedPersonaFilter !== 'all') && (
                  <button
                    ...
                    className="text-xs text-[#E60026] font-mono underline hover:text-white pt-2 cursor-pointer"
                  >
                ...
                return (
                  <div
                    ...
                    className={`rounded-xl border transition-all duration-200 overflow-hidden ${
                      isLoaded
                        ? 'bg-zinc-950 border-[#E60026] shadow-[0_0_25px_rgba(230,0,38,0.15)] ring-1 ring-[#E60026]'
                    ...
                    <div className="p-3.5 space-y-2.5">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          {isLoaded && (
                            <span className="px-2 py-0.5 rounded bg-[#E60026] text-black text-[9px] font-mono font-extrabold uppercase tracking-wider">
                              ● On Altar
                            </span>
                          )}
                        </div>
                      ...
                      {reading.question && (
                        <div className="p-2 rounded bg-zinc-950 border border-zinc-900 text-xs text-zinc-300 italic flex items-start gap-2">
                          <span className="text-[#E60026] font-mono font-bold text-xs">“</span>
                      ...
                      <div className="text-[11px] text-zinc-400 leading-relaxed line-clamp-2 pl-2 border-l-2 border-[#E60026]/60">
                        {reading.readingText}
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-zinc-900/80">
                        ...
                        <button
                          ...
                          className={`px-2.5 py-1.5 rounded-lg text-xs font-mono flex items-center gap-1.5 transition-all cursor-pointer ${
                            isPlaying
                              ? 'bg-[#E60026] text-black font-bold animate-pulse'
                              : 'bg-zinc-900 text-zinc-300 hover:bg-[#E60026]/20 hover:text-[#E60026] border border-zinc-800'
                          }`}
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          >
                            <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${isExpanded ? 'rotate-180 text-[#E60026]' : ''}`} />
                          </button>
                          ...
                          {itemToDelete === reading.id ? (
                            <div className="flex items-center gap-1">
                              <button
                                ...
                                className="px-2 py-1 bg-[#E60026] text-black text-[9px] font-mono font-bold rounded cursor-pointer"
                              >
                                Confirm
                              </button>
                              <button
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 bg-[#E60026] hover:bg-[#ff334b] text-black text-xs font-bold font-syne uppercase tracking-wider rounded-lg transition-all flex items-center gap-1 cursor-pointer shadow-sm"
                          >
                            <span>Revisit</span>
                      ...
                      <div className="p-4 bg-black/90 border-t border-zinc-900 space-y-3 animate-fadeIn">
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-1.5">
                            <span className="text-[10px] font-mono uppercase tracking-widest text-[#E60026] font-bold">
                          ...
                          <div className="text-xs text-zinc-300 leading-relaxed font-google-sans whitespace-pre-wrap pl-2.5 border-l-2 border-[#E60026]">
                            {reading.readingText}
                          </div>
                        </div>
                          ...
                          <div className="flex items-center justify-between mb-1">
                            ...
                            {editingNotesId !== reading.id && (
                              <button
                                ...
                                className="text-[10px] text-[#E60026] hover:underline font-mono cursor-pointer"
                              >
                          ...
                          {editingNotesId === reading.id ? (
                            <div className="space-y-2">
                              <textarea
                                ...
                                rows={3}
                                className="w-full bg-zinc-950 border border-zinc-800 text-xs p-2 rounded text-zinc-200 placeholder-zinc-700 outline-none focus:border-[#E60026] font-google-sans"
                              />
                              <div className="flex justify-end gap-2">
                                ...
                                <button
                                  ...
                                  className="px-3 py-1 bg-[#E60026] text-black text-xs font-bold rounded hover:bg-[#ff334b] cursor-pointer font-mono"
                                >
                                  Save Note
                                </button>
                              </div>
              ...
              {confirmClearAll ? (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 bg-red-600 text-white font-mono text-[10px] font-bold rounded cursor-pointer hover:bg-red-700"
                  >
                    Yes, Clear All
                  </button>
                  <button
